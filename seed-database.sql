...
-- Create table for practitioners
...
-- Seed Practitioners Table with Data
INSERT INTO practitioners (first_name, last_name, prefix, suffix, sex)
values ('Cynthia', 'Torrez',null, 'M.D.', 'F'),
  ('Kyle', 'West',null, 'M.D. ', 'M'),
  ('Brown', 'Johnson',null, 'M.D.','M'),
  ('Stella', 'Richardson','Mrs','R.N','F');
